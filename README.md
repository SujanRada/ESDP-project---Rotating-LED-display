...
<p align="center"> 
  <img src="figs/electronics architecture image.png" style="display: inline-block; margin: 20px; max-width: 600px">
</p>
...
**Key Specifications:**
- Input voltage: 24V  
- Output: 12V @ 3A (max), 36W  
- Coil size: Outer diameter 82 mm, Inner diameter 30 mm  
- Transmitter board size: 17 mm × 30 mm  
- Receiver board size: 30 mm × 54 mm  
...
## CAD model used for constant and stable wireless power
<p align="center"> 
